...
def upload_deobfuscation_map(deobfuscation_script_output, faid):
    ...
    with erasedTempDir() as tmpdir:
        ...
        if not os.path.exists(mapping_file):
            logging.warning("Missing mapping.txt file. Skipping code deobfuscation mapping file upload to Crashlytics.")
            return
